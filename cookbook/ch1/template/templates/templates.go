...
// 템플릿을 초기화하고 다양한 템플릿 도움 함수의 예시를 보여줌
func RunTemplate() error {
	data := struct {
		...
		Words:         "anothor_item1,another_item2,another_item3",
	...
	// 오류에 대응하기 위해 Must를 대신 사용할 수도 있음
	...
	// 블록의 예시를 보여주기 위해 첫 번째 템플릿을 복제한 다음 두번 째 템플릿을 파싱해 또 다른 템플릿을 생성함
	t2, err := t.Clone()
	if err != nil {
		return err
	}
